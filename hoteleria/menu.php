<nav class="navbar navbar-expand-lg navbar-dark fixed-top h5" style="background-color:#004993;">  
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active"><a href="Hosteleria.php" class="nav-link">Hosteleria</a></li>
      <li class="nav-item active"><a class="nav-link">ㅤㅤ</a></li>
      <li class="nav-item active"><a href="reporte.php" class="nav-link">Reporte de Movimientos</a></li>
      <li class="nav-item active"><a class="nav-link">ㅤㅤ</a></li>      
